					...
					<div class="card card-primary">
						<form action="" method="post">
							...
							<div class="card-body">
								...
								<div class="form-group">
									<label>Nombre de Sub Categorias <span style="color: red;">*</span> </label>
									<input type="text" class="form-control" name="name" required value="{{ old('name', $getRecord->name) }}" placeholder="Ingrese Nombre de Sub Categoria">
								</div>
								<div class="form-group">
