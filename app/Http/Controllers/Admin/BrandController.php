...
class BrandController extends Controller
{
    ...
    public function add()
    {
        $data['header_title'] = "Agregar Nueva Marca";
     ...
     public function insert(Request $request)
    {
        ...
        return redirect('admin/brand/list')->with('success', "Marca creada satisfactoriamente");
    }

    public function edit($id)
    {
        $data['getRecord'] = BrandModel::getSingle($id);
        $data['header_title'] = "Editar Marca";
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/brand/list')->with('success', "Marca actualizada satisfactoriamente");
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->back()->with('success', "Marca borrada satisfactoriamente");
    }
}
